            ...
            <div className="max-w-global mx-auto">
                <div className="absolute inset-0 bg-white min-h-screen flex flex-col gap-4">
                    <div className="bg-white fixed w-full h-14">
                        <button onClick={() => setShowAllPhotos(false)} className="bg-white absolute top-3 left-2 hover:bg-gray-100 rounded-full transition ease-in-out duration-200 py-1 px-2">
